...
\newcommand{\legende}[1]{\small\textsf{#1}} % légendes hors des flottants
...
% Le code suivant buggue dans beamer (peut être les environnements columns)
% Pour rendre inactifs les caractères : et autres
% \AtBeginDocument{%
...
\tikzset{>=latex}
\tikzset{coordonnees/.style={dashed,color=gray!80,text=black,thick}}
