(custom-set-variables
 ...
 '(package-selected-packages
   '(annotate dash avy-embark-collect avy-embark-consult ox-pandoc transient with-editor org-ref-core biblio-core rainbow-mode latex-extra expand-region yasnippet-snippets calfw-cal calfw-gcal calfw-ical calfw-org calfw poke-line consult-bibtex consult-notmuch fd-dired corfu popper consult-dir orderless vertico persp-mode try wgrep beacon all-the-icons-ibuffer all-the-icons-dired all-the-icons-completion highlight-indent-guides mpdel-embark mpdel offlineimap bbdb-vcard flycheck dired-toggle-sudo unison-mode pdf-tools auctex ob-ipython org-mru-clock which-key eww-lnum keychain-environment doom-modeline mingus org-review eri exec-path-from-shell gnus-bogofilter yasnippet gnuplot anzu bbdb quelpa-use-package org-caldav smartparens rainbow-delimiters minions unison free-keys paradox notmuch ace-window boxquote))
